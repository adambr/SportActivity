...
public interface CaloriesTableDAO {
     ...
     * @return caloriesTable with given id, or Null when CaloriesTable does not
     * exist.
     */
     ...
     * @throws IlleagalArgumentException when CaloriesTable with given id does
     * not exist.
     * @throws NullPointerException when given id is NULL.
     */
    void delete(Long id);
     ...
     * @throws IlleagalArgumentException when given CaloriesTable does not
     * exist.
     * @throws NullPointerException when given caloriesTable is NULL.
     */
