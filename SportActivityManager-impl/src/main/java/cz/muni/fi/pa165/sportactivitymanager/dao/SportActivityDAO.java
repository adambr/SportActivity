...
public interface SportActivityDAO {
     ...
     * @return SportActivity with same id, or Null when SportActivity does not
     * exist.
     */
     ...
     * @return SportActivity with same name, or Null when SportActivity does not
     * exist.
     */
     ...
     * @throws IlleagalArgumentException when given SportActivity does not
     * exist.
     * @throws NullPointerException when given sportActivity is NULL.
     * @return nothing
     */
     ...
     * @throws IlleagalArgumentException when SportActivity with given id does
     * not exist.
